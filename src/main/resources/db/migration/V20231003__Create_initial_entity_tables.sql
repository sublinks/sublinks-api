...
(
  ...
  `is_show_scores`                 BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_show_read_posts`             BOOLEAN                            NOT NULL DEFAULT TRUE,
  `is_show_nsfw`                   BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_show_new_post_notifications` BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_show_bot_accounts`           BOOLEAN                            NOT NULL DEFAULT TRUE,
  `is_show_avatars`                BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_send_notifications_to_email` BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_open_links_in_new_tab`       BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_infinite_scroll`             BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_keyboard_navigation`         BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_animated_images`             BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_collapse_bot_comments`       BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_auto_expanding`              BOOLEAN                            NOT NULL DEFAULT FALSE,
  `is_blur_nsfw`                   BOOLEAN                            NOT NULL DEFAULT FALSE,
