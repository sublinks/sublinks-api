...
public interface LinkPersonInstanceRepository extends JpaRepository<LinkPersonInstance, Long> {
    ...
    Collection<LinkPersonInstance> getLinkPersonInstancesByInstanceAndLinkTypeIsInAndPerson(Instance instance, Collection<LinkPersonInstanceType> linkTypes, Person person);
}
