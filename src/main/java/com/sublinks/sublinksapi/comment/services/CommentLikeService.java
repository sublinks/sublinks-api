...
public class CommentLikeService {
    ...
    public int getPersonCommentVote(final Person person, final Comment comment) {
        ...
        Optional<CommentLike> commentLike = commentLikeRepository.getCommentLikeByPersonAndComment(person, comment);
    ...
    @NonNull
    private void updateOrCreateCommentLike(final Comment comment, final Person person, final int score) {
