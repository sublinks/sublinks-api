...
public interface PrivateMessageMapper extends Converter<com.sublinks.sublinksapi.private_messages.dto.PrivateMessage, PrivateMessage> {
    @Override
    ...
    PrivateMessage convert(@Nullable com.sublinks.sublinksapi.private_messages.dto.PrivateMessage privateMessage);
}
